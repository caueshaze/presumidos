...
pub(super) async fn list_matches() -> ApiResult<impl IntoResponse> {
    Ok(Json(crate::matches::list_matches(String::new()).await?))
}

pub(super) async fn knockout_released() -> ApiResult<impl IntoResponse> {
    let released = crate::matches::is_knockout_released().await?;
    Ok(Json(json!({ "released": released })))
}

pub(super) async fn my_predictions(
...
pub(super) async fn my_prediction_overrides() -> ApiResult<impl IntoResponse> {
    Ok(Json(
        crate::admin::list_my_prediction_overrides(String::new()).await?,
    ))
}

pub(super) async fn my_match_points() -> ApiResult<impl IntoResponse> {
    Ok(Json(crate::scoring::list_my_match_points().await?))
}

pub(super) async fn submit_prediction(
    headers: HeaderMap,
...
pub(super) async fn prediction_reuse_suggestion(
...
pub(super) async fn prediction_reuse_copy(
    Path(pool_id): Path<String>,
    headers: HeaderMap,
) -> ApiResult<impl IntoResponse> {
    Ok(Json(
...
pub(super) async fn prediction_reuse_start_empty(
    Path(pool_id): Path<String>,
    headers: HeaderMap,
) -> ApiResult<impl IntoResponse> {
    Ok(Json(
...
pub(super) async fn submit_single_choice_prediction(
    headers: HeaderMap,
...
pub(super) async fn submit_numeric_prediction(
    headers: HeaderMap,
...
pub(super) async fn submit_multiple_choice_prediction(
    headers: HeaderMap,
...
pub(super) async fn set_multiple_choice_result(
...
pub(super) async fn mark_custom_result_not_representable(
    Path(item_id): Path<String>,
    headers: HeaderMap,
...
pub(super) async fn custom_questions(
...
pub(super) async fn custom_event_showcase(
    Query(query): Query<PoolIdQuery>,
) -> ApiResult<impl IntoResponse> {
    Ok(Json(
...
pub(super) async fn update_option_media_progress(
    headers: HeaderMap,
...
pub(super) async fn custom_member_predictions(
    Path(pool_id): Path<String>,
) -> ApiResult<impl IntoResponse> {
    Ok(Json(
...
pub(super) async fn pool_football_scoring(
    Path(pool_id): Path<String>,
) -> ApiResult<impl IntoResponse> {
    Ok(Json(
...
pub(super) async fn update_pool_football_scoring(
    Path(pool_id): Path<String>,
    headers: HeaderMap,
...
pub(super) async fn pool_custom_scoring(
...
pub(super) async fn update_pool_custom_scoring(
    Path((pool_id, item_id)): Path<(String, String)>,
    headers: HeaderMap,
...
pub(super) async fn set_custom_question_result(
    Path(item_id): Path<String>,
    headers: HeaderMap,
...
pub(super) async fn set_numeric_question_result(
    Path(item_id): Path<String>,
    headers: HeaderMap,
...
pub(super) async fn pool_numeric_scoring(
    Path((pool_id, item_id)): Path<(String, String)>,
) -> ApiResult<impl IntoResponse> {
    Ok(Json(
...
pub(super) async fn pool_multiple_choice_scoring(
    Path((pool_id, item_id)): Path<(String, String)>,
) -> ApiResult<impl IntoResponse> {
    Ok(Json(
...
pub(super) async fn update_pool_multiple_choice_scoring(
    Path((pool_id, item_id)): Path<(String, String)>,
    headers: HeaderMap,
...
pub(super) async fn update_pool_numeric_scoring(
    Path((pool_id, item_id)): Path<(String, String)>,
    headers: HeaderMap,
